...
<div id="block">
   ...
   <section>
        ...
        <div class="emplacements">
          ...
          <h2 class="conn">Modification et ajout des newsletter:</h2>
            ...
            <br> <br> <br>
             ...
             <p>Si vous voulez ajouter une news <a class="aa" href="ajouter.php">cliquer ici</a></p>

             <p>Si vous voulez supprimer une news <a class="aa" href="suppression.php">cliquer ici</a></p>

             <p>Si vous voulez modifier une news <a class="aa" href="modifier.php">cliquer ici</a></p>

             

             <a class="aaa" href="connexion.php" >se deconnecter</a>
 <?php  
                     if(isset($mess))
                     {
                       echo $mess;
