...
{
    if( !empty($_POST['titre']) && !empty($_POST['resume']) && !empty($_POST['contenu']) )
    {
        ...
        $req = $bdd->prepare('INSERT INTO news(titre, resume, contenu, date_publication) VALUES(:titre, :resume, :contenu, now())');
  ...
  $mess = '<p class="mess">Operation reussite !!</p>';
...
<div id="block">
   ...
   <section>
        ...
        <div class="emplacements">
          ...
          <h2 class="conn">Ajout des newsletter:</h2>
             ...
             <form method="POST" action="ajouter.php">
                  ...
                  <table class="tab">
                    ...
                    <tr>
                      ...
                      <td>
                      	<textarea rows="4" cols="30" placeholder="resume" name="resume"></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                      	<textarea rows="6" cols="42" placeholder="contenu" name="contenu"></textarea>
                      </td>
                    </tr>
